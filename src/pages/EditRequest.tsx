                  ...
                  <TabsContent value="upload" className="p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Textarea id="description" placeholder="توضیحات لازم برای ویرایش تصاویر را وارد کنید" className="min-h-[100px]" />
                      </div>
                        ...
                        {files.length > 0 && <div className="mt-4 space-y-2">
                            ...
                            <div className="space-y-2">
                              {files.map((file, index) => <div key={index} className="flex items-center justify-between bg-white p-3 rounded-lg shadow-sm border">
                                  ...
                                  <button type="button" onClick={() => handleDeleteFile(index)} className="text-red-500 hover:text-red-700">
                  ...
                  <TabsContent value="link" className="p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <Textarea id="description-link" placeholder="توضیحات لازم برای ویرایش تصاویر را وارد کنید" className="min-h-[100px]" />
                      </div>
