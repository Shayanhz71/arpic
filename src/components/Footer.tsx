        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-400 hover:text-white">صفحه اصلی</Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-400 hover:text-white">خدمات</Link>
              </li>
              <li>
                <Link to="/shop" className="text-gray-400 hover:text-white">فروشگاه</Link>
              </li>
              <li>
                <Link to="/cooperation" className="text-gray-400 hover:text-white">همکاری با ما</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-white">درباره ما</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-white">تماس با ما</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/portrait" className="text-gray-400 hover:text-white">رتوش پرتره</Link>
              </li>
              <li>
                <Link to="/services/wedding" className="text-gray-400 hover:text-white">ادیت عکس عروسی</Link>
              </li>
              <li>
                <Link to="/services/skin" className="text-gray-400 hover:text-white">رتوش پوست</Link>
              </li>
              <li>
                <Link to="/services/album" className="text-gray-400 hover:text-white">طراحی آلبوم</Link>
              </li>
              <li>
                <Link to="/services/commercial" className="text-gray-400 hover:text-white">عکاسی صنعتی</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-3 space-x-reverse">
                <svg className="h-6 w-6 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span className="text-gray-400">۰۲۱-۸۸۸۸۸۸۸۸</span>
              </li>
              <li className="flex items-start space-x-3 space-x-reverse">
                <svg className="h-6 w-6 text-gray-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
